...
public class NoDoubleValidatorTest {

	String puzzleInput = "bdwdjjo avricm cjbmj ran lmfsom ivsof\n" + 
	...
	public void testValidPassphrase() {
		...
		boolean result = isValid(passphrase, identity());
	...
	@Test
	public void countValidPassphrases() {
		String[] passphrases = puzzleInput.split("\n");
		
		List<String> validPassphrases = Stream.of(passphrases)//
			.filter(p -> isValid(p, identity()))
			.collect(toList());
		
		System.out.println(validPassphrases.size());
	}
	...
	public void testWithoutAnagram() {
		...
		boolean result = isValid(passphrase, sortedAnagram);
	...
	@Test
	public void testAnotherWithoutAnagram() {
	...
	@Test
	public void testAnotherAgainWithoutAnagram() {
	...
	@Test
	public void testAnotherNotValid() {
	...
	@Test
	public void countValidPassphrasesWithAnagrams() {
		String[] passphrases = puzzleInput.split("\n");
		
		List<String> validPassphrases = Stream.of(passphrases)//
			.filter(p -> isValid(p, sortedAnagram))
			.collect(toList());
		
		System.out.println(validPassphrases.size());
	}

	private static final Function<String, String> sortedAnagram = word -> word.chars().sorted().collect(StringBuilder::new,
	        StringBuilder::appendCodePoint, StringBuilder::append).toString();
	
	
	private boolean isValid(String passphrase, Function<String, String> wordProcessor) {
		
		List<String> words = Stream.of(passphrase.split(" "))//
			.map(wordProcessor)
			.collect(toList());
		
		Set<String> wordSet = new HashSet<>(words);
		return words.size() == wordSet.size();
	}
